...
(function() {
  ...
  Notifications = (function() {
    ...
    Notifications.prototype.add = function(id, type, body, timeout) {
      ...
      $(".body", elem).cssLater("box-shadow", "0px 2px 2px rgba(0,0,0,0.3)", 1000);
      $(".body", elem).cssLater("border", "solid rgba(0,0,0,0.5)", 1000);  
      $(".body", elem).cssLater("border-width", "1px 1px 1px 0px", 1000);
      $(".body", elem).cssLater("border-style", "solid solid solid none", 1000);       
      $(".notification-icon, .close, .button, .circle", elem).on("click", (function(_this) {
        return function() {
          _this.close(elem);
          return false;
        };
